classdef argMIN_Resident 
    ...
    methods
        ...
        function C=Cost_func(obj,Pbat_j,GG2Bat_j,SOC) 
            C=0.01*(obj.Bat_cap./(SOC*obj.Bat_cap+obj.eta*GG2Bat_j*obj.Time_int-Pbat_j*obj.Time_int/obj.eta));
        end 
        function [Pbuy_j,Pbat_j] =Solve(obj,tilde_Lambda,X1_j,beta,PbuyOld,PbatOld,SOC,GG2Bat,mu,j,k) 
            ...
            ub=(SOC*obj.Bat_cap+obj.eta*GG2Bat*obj.Time_int)*obj.eta/obj.Time_int;
            x0=[PbuyOld,PbatOld];
